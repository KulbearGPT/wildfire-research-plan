...
case "${year}" in
  2021|2022|2023) ;;
  *) echo "P11 evaluation year must be 2021, 2022, or 2023" >&2; exit 2 ;;
esac
...
run_root=${base}/runs/prototype-P11-MissingnessRouter-${year}-${SLURM_JOB_ID}
...
cp "${runner_path}" "${run_root}/run_reliability_router_on_nibi.sh"

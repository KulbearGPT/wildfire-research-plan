...
run_root=${base}/runs/prototype-P13-FireDropOnly-${SLURM_JOB_ID}
p13_checkpoint=${run_root}/fire-only.pt
...
cp "${runner_path}" "${run_root}/run_fire_only_on_nibi.sh"

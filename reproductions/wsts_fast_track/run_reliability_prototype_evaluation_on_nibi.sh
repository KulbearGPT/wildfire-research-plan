...
if [[ $# -ne 1 ]]; then
  echo "usage: $0 P01_COMPLETED_RECORD" >&2
  exit 2
fi
...
run_root=${base}/runs/prototype-P01-eval-2021-${SLURM_JOB_ID}
...
cp "${runner_path}" "${run_root}/run_reliability_prototype_evaluation_on_nibi.sh"

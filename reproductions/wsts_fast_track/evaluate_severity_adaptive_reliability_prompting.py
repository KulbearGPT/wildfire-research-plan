"""Evaluate the retained D12 severity-adaptive prompting method."""
...
def load_sarp_model(
    ...
    """Reconstruct the fixed ResNet-18 base and D12 prompts."""
    ...
    model = SeverityAdaptiveReliabilityPrompting(base_model)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    candidate_id = validate_sarp_checkpoint(payload)

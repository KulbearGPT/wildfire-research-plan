"""Train the single P01 FireDrop-plus-validity rapid prototype."""
...
from .prototype import (
    ...
    install_training_fire_dropout_with_validity,
)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    install_training_fire_dropout_with_validity(upstream_root)

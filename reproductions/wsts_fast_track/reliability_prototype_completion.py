"""Seal the one P01 reliability-aware rapid-prototype training run."""
...
from .prototype import FIRE_DROPOUT_PROBABILITY, RELIABILITY_PROTOTYPE_ID
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    record = {
        "status": "pass",
        "purpose": "rapid 2021-selected reliability prototype",

...
> **教学接手入口（2026-09-11）：** [完整实验 Roadmap](docs/research-roadmap.md) · [Git 提交核对](docs/project-handoff-git-audit.md)。当前交付已整合 T=1/T=5、跨架构及两套 September 实现，入口以上方研究交付文档为准；下方正文保留早期 T=1 阶段说明。
